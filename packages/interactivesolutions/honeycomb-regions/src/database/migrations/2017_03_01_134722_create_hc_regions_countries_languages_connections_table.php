...
class CreateHcRegionsCountriesLanguagesConnectionsTable extends Migration {
	...
	public function up()
	{
		Schema::create('hc_regions_countries_languages_connections', function(Blueprint $table)
		{
			...
			$table->timestamps();
			$table->string('country_id', 36)->index('fk_hc_regions_countries_languages_connections_hc_regions_count1');
			$table->string('language_id', 36)->index('fk_hc_regions_countries_languages_connections_hc_languages1_idx');
