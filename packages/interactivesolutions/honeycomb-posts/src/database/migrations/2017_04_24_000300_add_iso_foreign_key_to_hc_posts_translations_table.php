...
class AddIsoForeignKeyToHcPostsTranslationsTable extends Migration {
	...
	public function up()
	{
        ...
        {
            $table->foreign('language_code', 'fk_hc_posts_translations_hc_languages1')->references('iso_639_1')->on('hc_languages')->onUpdate('NO ACTION')->onDelete('NO ACTION');
        });
	}
